...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  call <sid>X('MatchParen',   s:syntax_fg,     s:mono_4,         '')
  ...
  call <sid>X('StatusLineNC', s:syntax_cursor, s:mono_3,         '')
  ...
  call <sid>X('Operator',       s:hue_3,         '',          'none')
  call <sid>X('Keyword',        s:hue_3,         '',          '')
  ...
  call <sid>X('StorageClass',   s:hue_3,         '',          '')
  call <sid>X('Structure',      s:hue_3,         '',          '')
